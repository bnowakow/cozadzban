...
@TestPropertySource(
    properties = [
        ...
        "COZADZBAN_BOOTSTRAP_ADMIN_EMAIL=admin@ownership.test",
    ],
)
class ArticleOwnershipIT {
    ...
    @Test
    fun `cache prefers complete Facebook lead over longer ellipsis teaser`() {
        val teaser = "Pete Hegseth has fired 24 generals. Now he brings his wife to Pentagon meetings. " +
            "She has no security clearance.The Guardian published a major investigation Sunday. " +
            "The headline finding: Hegseth's..."
        val fullLead = """
