...
class EnrichmentService(
    ...
    private fun executeFacebookPhotoCurl(
        ...
        val outputFile = Files.createTempFile("cozadzban-facebook-photo-curl-", ".out")
        val startedAt = System.nanoTime()
        try {
    ...
    private fun facebookPhotoCurlExecutable(): String =
        System.getenv("COZADZBAN_CURL_PATH")?.takeIf { it.isNotBlank() } ?: "curl"
    ...
    companion object {
        ...
        private const val CURL_FALLBACK_META_START_TOKEN = "__COZADZBAN_CURL_META_START__"
        private const val CURL_FALLBACK_META_END_TOKEN = "__COZADZBAN_CURL_META_END__"
